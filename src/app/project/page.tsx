...
const ProjectPage: React.FC = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const [projectsData, tasksData, usersData, boardData] = await Promise.all([
          ...
          boardService.getTasks(projectId as string),
          boardService.getUsers(),
          boardService.getBoard(projectId as string),
        ]);
  ...
  const handleBoardUpdate = async (columns: Record<string, Column>, columnOrder: string[]) => {
    try {
      const updatedBoard = await boardService.updateBoard(projectId as string, columns, columnOrder);
